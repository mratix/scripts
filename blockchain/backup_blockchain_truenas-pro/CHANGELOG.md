...
v1.1.5
  ...
  snapshot: trimmed seconds from snapname, conforming to TrueNAS naming scheme
  Improvements in the handling of chia
...
- fix: rsync array handling and exit code propagation
- fix: LOGFILE and STATEFILE default expansion
